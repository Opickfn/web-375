<div class="report-creation-shell">
    <div class="min-h-screen py-12 px-4">
        <div class="max-w-4xl mx-auto">
            {{-- Warning Header for Public Reports --}}
            ...
            {{-- Header Section --}}
            <div class="mb-8 animate-in" style="animation-delay: 100ms;">
                <h1 class="text-3xl font-black text-white mb-2 flex items-center gap-3">
                    <i data-lucide="globe" class="text-[#f59e0b]"></i>
                    Kontribusi Temuan Publik
                </h1>
                <p class="text-slate-400">Suarakan temuan Anda untuk POLMAN yang lebih baik.</p>
            </div>
            ...
            @else
                {{-- Form Section --}}
                <div class="glass-card animate-in" style="animation-delay: 200ms;">
                    <form wire:submit.prevent="submit" class="p-8 space-y-8">
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="form-field lg:col-span-1">
                                ...
                                <div class="input-container">
                                    <input type="text" wire:model="detail_lokasi" class="modern-input text-slate-900 bg-white" placeholder="Contoh: Saluran air tersumbat..." required>
                                </div>
                        ...
                        <div class="form-field">
                            ...
                            <div class="input-container">
                                <textarea wire:model="deskripsi" rows="5" class="modern-input text-slate-900 bg-white min-h-[120px]" placeholder="Jelaskan detail apa yang Anda temukan..."></textarea>
                            </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-8">
                            <div class="form-field">
                                ...
                                <div class="upload-area" onclick="document.getElementById('bukti_publik').click()">
                                    <input type="file" id="bukti_publik" wire:model="bukti" accept="image/*" class="hidden">
                                    @if($bukti)
